...
list_line = [quan_line_one, quan_line_two, quan_line_three,-100]

with open('4.txt', 'a', encoding='utf-8') as final_text:
    for i_ in range(3):
        ...
        if quan_line_two == max(list_line):
        ...
        if quan_line_three == max(list_line):
